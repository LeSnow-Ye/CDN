  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      var a = n(26),
        ...
        j = "",
        T = {
          cdn: "https://api.btstu.cn/sjtx/api.php?lx=c1&format=images",
          ds: [
            "mp",
            "identicon",
            "monsterid",
            ...
            if ((p = p instanceof HTMLElement ? p : f[f.length - 1] || null)) {
              ...
              var v = (0 == e.config.meta.length
                ...
                g =
                  ...
                  '">' +
                  v.join("") +
                  '</div><div class="vedit"><textarea style="background: url(' +
                  myPix[randomNum] +
                  ') 100% 100% no-repeat;" id="veditor" class="veditor vinput" placeholder="' +
                  ...
                  e.i18n.t("preview") +
                  '" class="vicon vpreview-btn"><svg  viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="17688" width="22" height="22"><path d="M502.390154 935.384615a29.538462 29.538462 0 1 1 0 59.076923H141.430154C79.911385 994.461538 29.538462 946.254769 29.538462 886.153846V137.846154C29.538462 77.745231 79.950769 29.538462 141.390769 29.538462h741.218462c61.44 0 111.852308 48.206769 111.852307 108.307692v300.268308a29.538462 29.538462 0 1 1-59.076923 0V137.846154c0-26.899692-23.355077-49.230769-52.775384-49.230769H141.390769c-29.420308 0-52.775385 22.331077-52.775384 49.230769v748.307692c0 26.899692 23.355077 49.230769 52.775384 49.230769h360.999385z" p-id="17689"></path><path d="M196.923077 216.615385m29.538461 0l374.153847 0q29.538462 0 29.538461 29.538461l0 0q0 29.538462-29.538461 29.538462l-374.153847 0q-29.538462 0-29.538461-29.538462l0 0q0-29.538462 29.538461-29.538461Z" p-id="17690"></path><path d="M649.846154 846.769231a216.615385 216.615385 0 1 0 0-433.230769 216.615385 216.615385 0 0 0 0 433.230769z m0 59.076923a275.692308 275.692308 0 1 1 0-551.384616 275.692308 275.692308 0 0 1 0 551.384616z" p-id="17691"></path><path d="M807.398383 829.479768m20.886847-20.886846l0 0q20.886846-20.886846 41.773692 0l125.321079 125.321079q20.886846 20.886846 0 41.773693l0 0q-20.886846 20.886846-41.773693 0l-125.321078-125.321079q-20.886846-20.886846 0-41.773693Z" p-id="17692"></path></svg></span></div></div></div><div class="vrow"><div class="vcol vcol-30" ><a alt="Markdown is supported" href="https://guides.github.com/features/mastering-markdown/" class="vicon" target="_blank"><svg style="display: none;" class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="vcol vcol-70 text-right"><button type="button"  title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' +
                  e.i18n.t("submit") +
                  '</button></div></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div><div style="display:none;" class="vmark"></div></div></div><div class="vcount" style="display:none;color: #e58a8a;"><span class="vnum">0</span> ' +
                  e.i18n.t("comments") +
        ...
        (o.prototype.bind = function () {
          ...
          var C = function (t, n, r) {
              ...
              i &&
                ...
                (a =
                  '<span style="color: #4cd3c2;background: #ededed;" class="vsys"><i class="fab fa-' +
              ...
              var qqa = qqm
                ? "https://q2.qlogo.cn/headimg_dl?dst_uin=" + qqm + "&spec=100"
                : null;
              var qal =
              ...
              var l = t.get("link")
                ...
                d =
                  ...
                  " " +
                  a +
                  '</div><div class="vmeta"><span style="color: red;" class="vtime" >' +
    ...
    function (e, t) {
      e.exports = {
        ...
        alu3:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/不出所料.png",
        alu4:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/不说话.png",
        alu5:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/不高兴.png",
        alu6: "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/中刀.png",
        alu7: "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/中指.png",
        alu8: "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/中枪.png",
        alu9: "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/亲亲.png",
        alu10:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/便便.png",
        alu11:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/内伤.png",
        alu12:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/击掌.png",
        alu13:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/口水.png",
        alu14: "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/吐.png",
        alu15:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/吐舌.png",
        alu16:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/吐血倒地.png",
        alu17:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/呲牙.png",
        alu18:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/咽气.png",
        alu19:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/哭泣.png",
        alu20:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/喜极而泣.png",
        alu21:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/喷水.png",
        alu22:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/喷血.png",
        alu23:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/坐等.png",
        alu24:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/害羞.png",
        alu25:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/小眼睛.png",
        alu26:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/尴尬.png",
        alu27:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/得意.png",
        alu28:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/惊喜.png",
        alu29:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/想一想.png",
        alu30:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/愤怒.png",
        alu31:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/扇耳光.png",
        alu32:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/投降.png",
        alu33:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/抠鼻.png",
        alu34:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/抽烟.png",
        alu35:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/无奈.png",
        alu36:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/无所谓.png",
        alu37:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/无语.png",
        alu38:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/暗地观察.png",
        alu39:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/期待.png",
        alu40:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/欢呼.png",
        alu41: "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/汗.png",
        alu42:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/深思.png",
        alu43:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/狂汗.png",
        alu44:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/献花.png",
        alu45:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/献黄瓜.png",
        alu46:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/皱眉.png",
        alu47:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/看不见.png",
        alu48:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/看热闹.png",
        alu49:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/瞅你.png",
        alu50:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/肿包.png",
        alu51:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/脸红.png",
        alu52:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/蜡烛.png",
        alu53:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/装大款.png",
        alu54:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/观察.png",
        alu55:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/赞一个.png",
        alu56:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/邪恶.png",
        alu57:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/锁眉.png",
        alu58:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/长草.png",
        alu59:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/阴暗.png",
        alu60:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/高兴.png",
        alu61:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/黑线.png",
        alu62:
          "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN/alu/鼓掌.png",
      };
    },
    function (e, t) {
      e.exports = {
